...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextAreaDesscription = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jPanelToolBar.setBackground(new java.awt.Color(18, 61, 230));
        ...
        jTextAreaDesscription.setColumns(20);
        jTextAreaDesscription.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jTextAreaDesscription.setRows(5);
        jScrollPane1.setViewportView(jTextAreaDesscription);
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try {
            if (!jTextFieldName.getText().equals("")) {
                ...
                project.setDescription(jTextAreaDesscription.getText());
    ...
    private javax.swing.JTextArea jTextAreaDesscription;
